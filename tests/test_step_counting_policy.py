...
def test_eval_configs_use_400_max_episode_steps():
    for config_path in [
        Path("config/habitat_eval_hm3dv1.yaml"),
        Path("config/habitat_eval_hm3dv2.yaml"),
        Path("config/habitat_eval_mp3d.yaml"),
    ]:
        assert "max_episode_steps: 400" in config_path.read_text(encoding="utf-8")


def test_eval_configs_allow_both_agents_to_run_perception_each_step():
    for config_path in [
        Path("config/habitat_eval_hm3dv1.yaml"),
        Path("config/habitat_eval_hm3dv2.yaml"),
        Path("config/habitat_eval_mp3d.yaml"),
        ...
        assert "perception_agents_per_step: 2" in text
...
def test_readme_documents_step_counting_policy_and_max_steps():
    ...
    assert "max_episode_steps: 400" in text
